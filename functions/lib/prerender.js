...
function wrapHTML(title, description, canonical, body, jsonld) {
    return `<!doctype html>
<html lang="en">
<head>
<meta charset="UTF-8" />
...
async function renderWorkerPage(slug) {
...
<main style="max-width:720px;margin:0 auto;padding:2rem">
  ...
  <p><a href="/" style="display:inline-block;background:#06afb8;color:white;padding:1rem 2rem;border-radius:12px;text-decoration:none;font-weight:bold;margin-top:1rem">Find a Worker Now</a></p>
    ...
    return wrapHTML('Traamand Employment Services | Verified Domestic Workers in Harare', 'Hire vetted, background-screened domestic workers in Harare, Zimbabwe. Maids, nannies, chefs, gardeners — book in 3 taps with the Divine Seal guarantee.', BASE_URL, body, jsonld);
}
exports.prerender = (0, https_1.onRequest)({ region: 'us-central1' }, async (req, res) => {
