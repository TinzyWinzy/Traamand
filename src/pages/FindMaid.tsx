...
export default function FindMaid() {
  return (
    <>
      <Helmet>
        <title>Find a Maid or Domestic Worker — {COMPANY_NAME}</title>
        <meta name="description" content={`Tell us what you need and we'll match you with a document-verified, background-screened domestic worker from ${COMPANY_NAME}. Browse available workers in Harare.`} />
      </Helmet>
