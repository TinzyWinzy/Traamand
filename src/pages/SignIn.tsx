...
import { Shield, Loader2, ArrowLeft, Mail, Lock, UserIcon } from 'lucide-react'
        ...
        <div className="rounded-2xl bg-white p-6 shadow-md sm:p-8">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Select your account type to sign in or create an account.
            </p>
          </div>

          <div className="mb-5">
            <label className="mb-1.5 block text-sm font-bold text-slate-700">I am a</label>
            <select
              value={role}
